...
const UsernameModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/90 p-4">
      <div className="w-full max-w-sm space-y-6 rounded-xl bg-card p-6 border border-border">
        <h2 className="text-xl font-bold text-primary text-center">בחר שם משתמש</h2>
        <Input
